#!/usr/bin/env python3
"""
Aegis Sentinel API Server
========================

This script starts the API server with ML capabilities.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Aegis Sentinel API Server')
...
def main():
    ...
    # Create FastAPI app
    app = create_api_app(graph, ml_engine)
